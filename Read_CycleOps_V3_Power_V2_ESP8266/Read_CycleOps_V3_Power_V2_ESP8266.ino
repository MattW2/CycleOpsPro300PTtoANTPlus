...
#define USE_TELNET_CONSOLE
  ...
  const char* password = "9084586288";
...
static const int RTS_PIN      = 13; //!< RTS on the nRF24AP2 module
//static const int RTS_PIN_INT  = 0; //!< The interrupt equivalent of the RTS_PIN


#if !defined(ANTPLUS_ON_HW_UART)
static const int TX_PIN       = 5; //Using software serial for the UART
static const int RX_PIN       = 4; //Ditto
